...
function Yesterday() {
  ...
  return (
    <MapContainer center={route[0]} zoom={8} style={{ height: '100vh', width: '100%' }}>
      ...
      <Marker position={route[4]}  icon={locationIcon}/>
      <Marker position={position}  icon={carIcon}/>
      <div class="card text-center">
         <h5 class="card-title">Configure</h5>
         <div class="dropdown">
             <button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Yesterday</button>
